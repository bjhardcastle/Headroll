...
for cidx = 1
    ...
    if errbar == 1
        ...
        plot(t, nanmean(condmean(cidx).fly),'Color',color_mat{2},'LineWidth',1 )
    end
...
% export_fig('C:\Users\Ben\Dropbox\Work\Thesis\Chapter_3\Figures\calliphora_chirp','-openGL','-r660' )
