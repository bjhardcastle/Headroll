...
set(gca,'box','off')
legend([sline.mainLine,hline.cond(1).mainLine,hline.cond(2).mainLine,hline.cond(3).mainLine],'TR','C2: No ocelli','C3: Dark','C4: No halteres')
legend('boxoff')
set(gcf,'Position', [103 141 300 240]);
...
if cid_extra ~= 1,
    ...
    fline(cidx) = plot(f,smooth(rr,50),'Color',color_mat{cidx+1},'LineWidth',1);
end
end
