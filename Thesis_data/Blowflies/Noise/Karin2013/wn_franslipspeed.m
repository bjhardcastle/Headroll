...
shadedErrorBar(result(1,2,p).x_resp, nanmean(hist_resp_2')./nanmean(hist_stim_1'),nanstd(hist_resp_2'./hist_stim_1'),{'m','LineWidth',2},1)
...
% C4 has no std as there's only 1 fly
plot(result(1,4,p).x_resp, nanmean(hist_resp_4')./nanmean(hist_stim_1'),'c','LineWidth',2)
