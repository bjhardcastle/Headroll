...
fly_array = [8, 9, 10, 12, 14, 17]     % numbers of flies to be included in study (remove fly8, no publishable data)
...
PlotdB = 2;                     % 1.. dB w/ std in linear space
                                % 2.. dB w/std in log space
                                % 0.. gain (not yet implemented)
