...
% save_command_G = strcat('G_fly',int2str(flyidx),'C',int2str(cond),'A',int2str(amp),'.freq',int2str(freq),'=step_vector_G;');

stimperiod = round(Fs/stimfreqs(freqidx));                                            % Stimulus Period in samples
