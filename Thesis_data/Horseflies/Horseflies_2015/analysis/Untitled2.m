...
fly_array = [2,3,4,5];    % numbers of flies to be included in study (remove fly8, no publishable data)
...
%       export_fig(['C:\Users\Ben\Dropbox\Work\Thesis\Chapter_3\Figures\tabanus_slipspeedSTANDARDFREQS'], '-openGL','-r660')
...
%     export_fig(['C:\Users\Ben\Dropbox\Work\Thesis\Chapter_3\Figures\tabanus_slipspeedsMAX'], '-openGL','-r660')
