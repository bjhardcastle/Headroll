...
%                                     if flying == 1
%                                     headroll(fly_nr).cond(cond_nr).freq(freq_nr).trial(:,repeat) =
%                                      headroll(fly_nr).cond(cond_nr).freq(freq_nr).offset
%                                       headroll(fly_nr).cond(cond_nr).freq(freq_nr).gain
%                                       headroll(fly_nr).cond(cond_nr).freq(freq_nr).gain_std
%                                        headroll(fly_nr).cond(cond_nr).freq(freq_nr).phase
%                                        headroll(fly_nr).cond(cond_nr).freq(freq_nr).phase_std
%                                        headroll(fly_nr).cond(cond_nr).freq(freq_nr).cycles
%                                     else
%                                     static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).trial(:,repeat) =
%                                      static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).offset
%                                       static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).gain
%                                       static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).gain_std
%                                       static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).phase
%                                        static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).phase_std
%                                         static_headroll(fly_nr).cond(cond_nr).freq(freq_nr).cycles
%                                     end
