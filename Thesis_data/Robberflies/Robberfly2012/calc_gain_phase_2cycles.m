...
save_command_G = strcat('Punit.A',int2str(amp_nr),'C',int2str(cond),'.freq',int2str(freq),'(',int2str(fly),',:)=step_vector_G;');
save_command_H = strcat('Punit.phaseA',int2str(amp_nr),'C',int2str(cond),'.freq',int2str(freq),'(',int2str(fly),',:)=phase_vector_H;');
