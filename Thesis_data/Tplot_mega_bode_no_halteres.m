...
%% Preliminary megabode plot. Looks like a mess. 
% Could do with 20,25 Hz for blowfly

%% Standard bode plot stuff. Should combine with above.
...
h1{3} = mseb(temp{3}.mainLine.XData,temp{3}.mainLine.YData,temp{3}.mainLine.YData-temp{3}.edge(2).YData,lineprops,1);
...
h1{4} = mseb(temp{4}.mainLine.XData,temp{4}.mainLine.YData,temp{4}.mainLine.YData-temp{4}.edge(2).YData,lineprops,1);
...
% lineprops.col = {color_mat{2}};
h1{1} = mseb(temp{2}.mainLine.XData,temp{2}.mainLine.YData,temp{2}.mainLine.YData-temp{2}.edge(2).YData,lineprops,1);
...
% lineprops.col = {horse_cols{3}};
h1{2} = mseb(temp{3}.mainLine.XData,temp{3}.mainLine.YData,temp{3}.mainLine.YData-temp{3}.edge(2).YData,lineprops,1);

%%%%%%%%%%%%%%%%%%

        
title(['Frequency response: all flies, without halteres'])
ylabel('Gain')
...
% % lineprops.col = {hov_cols{3}};
h2{3} =mseb(temp{3}.mainLine.XData,temp{3}.mainLine.YData,temp{3}.mainLine.YData-temp{3}.edge(2).YData,lineprops,1);
...
% % lineprops.col = {robber_cols{3}};
h2{4} = mseb(temp{4}.mainLine.XData,temp{4}.mainLine.YData,temp{4}.mainLine.YData-temp{4}.edge(2).YData,lineprops,1);
...
% lineprops.col = {color_mat{2}};
h2{1} = mseb(temp{2}.mainLine.XData,temp{2}.mainLine.YData,temp{2}.mainLine.YData-temp{2}.edge(2).YData,lineprops,1);
...
% lineprops.col = {horse_cols{3}};
h2{2} = mseb(temp{3}.mainLine.XData,temp{3}.mainLine.YData,temp{3}.mainLine.YData-temp{3}.edge(2).YData,lineprops,1);
...
set(gcf,'Position',plotsize_bode);
     set(gcf,'color','w');
export_fig(['C:\Users\Ben\Dropbox\Work\Thesis\Chapter_3\Figures\bode_mega_no_halteres'], '-openGL','-r660')
