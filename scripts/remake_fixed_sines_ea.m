...
if bode_rel_first
    save(fullfile(rootpathHR,'..\mat\DATA_ea_fixed_sines_rel_first.mat'),'headroll','framerates','stims','flies','stimfreqs');
    ...
    save(fullfile(rootpathHR,'..\mat\DATA_ea_fixed_sines.mat'),'headroll','framerates','stims','flies','stimfreqs');
