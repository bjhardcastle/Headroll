...
if bode_rel_first
    ...
    save(fullfile(rootpathHR,'..\mat\DATA_tb_fixed_sines_rel_first.mat'),'headroll','framerates','flies','stimfreqs','stims')
else
    ...
    save(fullfile(rootpathHR,'..\mat\DATA_tb_fixed_sines.mat'),'headroll','framerates','flies','stimfreqs','stims')
end
